...
.tabset makes so that the #header the next letter down are separate tabs in html; .tabset-fade makes the tabs fade when switching between them

### Cool animal fun facts {.tabset .tabset-fade}

#### Ringtail Cat

![Ringtail cat (courtesy of VA Zoo)]

- Can rotate their feet 180 degrees for climbing
